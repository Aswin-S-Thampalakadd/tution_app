    ...
    >
      ...
      <View style={styles.courseContent}>
        ...
        <View style={styles.nextLessonContainer}>
          <Ionicons name="play-circle" size={16} color="#20434F" />
    ...
    <TouchableOpacity style={styles.courseCard}>
      ...
      <View style={styles.courseContent}>
        ...
        <TouchableOpacity style={styles.viewCertificateButton}>
          ...
          <Ionicons name="document-text-outline" size={18} color="#20434F" />
        </TouchableOpacity>
      </View>
    </TouchableOpacity>
  );
  ...
  const renderCertificate = ({ item }) => (
    <TouchableOpacity style={styles.certificateCard}>
      ...
      <View style={styles.certificateContent}>
        ...
        <Text style={styles.certificateDate}>Issued: {item.issuedDate}</Text>
        <View style={styles.certificateGrade}>
          <Ionicons name="trophy" size={16} color="#FFD700" />
          <Text style={styles.certificateGradeText}>Grade: {item.grade}</Text>
        </View>
        <TouchableOpacity style={styles.downloadButton}>
          <Ionicons name="download-outline" size={16} color="#20434F" />
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.notificationButton}>
          <Ionicons name="notifications-outline" size={24} color="#20434F" />
